...
export function particlesJS(elem, params) {
	//console.log(params);
	...
	/* append canvas */
	var canvas = elem.appendChild(canvas_el);
...
export function load(elem, path_config_json, callback) {
	/* load json config */
	var xhr = new XMLHttpRequest();
